...
class DeployHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        try:
            ...
            # 1. Глубокий поиск SHA коммита (Твой эталонный рабочий блок)
            ...
            # 3. Жесткая зачистка портов перед запуском
            ...
            # 4. Запуск приложения с явным пробросом DEPLOY_REF во все интерфейсы (0.0.0.0)
